        ...
        <div className='px-2 mt-5 text-sm text-gray-600 font-medium'>
          {navItems.map(({ to, label, Icon }) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `px-3.5 py-2.5 flex items-center gap-3 rounded transition-all ${isActive ? 'bg-gradient-to-r from-[#3C81F6] to-[#9234EA] text-white' : 'text-gray-800 hover:bg-gray-100'}`
              }
            >
