  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
        ...
        />
                ...
                <button className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#41d8f6] to-[#0c19ae] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
            ...
            <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 '>
                ...
                <div className='flex-1 flex flex-col justify-center items-center text-sm text-gray-400 gap-5'>
                    ...
                    <p>Upload an image and click " Remove Objeect " to get started</p>
                </div>
            </div>
